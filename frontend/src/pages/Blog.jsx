...
export default function Blog() {
  ...
  const [fValues, setFValue] = useState({
    name:'',
    phone:'',
    email:'',
    subject:'',
  ...
  function handleChange(e) {
    setFValue({...fValues, [e.target.name]:[e.target.value]})
  }
          ...
          <form onSubmit={handleSubmit}>
            <div className="first-row">
              <label htmlFor="name">
                <svg
                  ...
                  id="person-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
              ...
              <input type="text" id="name" placeholder="שם" name="name" onChange={handleChange} required />

              <label htmlFor="phone">
                <svg
                  className="leave-message-icon"
                  id="telephone-icon" viewBox="0 0 512 512">
            ...
            <div className="second-row">
              ...
              <label htmlFor="subject">
                <svg
                  className="leave-message-icon"
                  id="subject-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <input type="reset" value="לנקות" id="resetBtn" />
            <br />
